  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <main className='fixed top-0 bottom-0 left-0 right-0 flex bg-gray-200'>
          {/* <RoomAside /> */}
          ...
          {/* Main messages */}
          <div className='flex-col items-center justify-center hidden w-full p-4 mx-2 my-2 text-center bg-gray-100 sm:flex top-2 bottom-2 left-20 rounded-xl text-slate-800'>
            {currentUser && (
              <>
                <h2 className='m-2 text-3xl font-bold text-slate-800'>
                  Hi, <span>{currentUser && currentUser?.name}</span>{' '}
                  <span>{currentUser && currentUser?.lastname}</span>
                </h2>
                <p>Select please one contact to start a chat </p>
                <h5 className='mt-5 text-8xl animate-pulse'>
                  <MdMessage />
                </h5>
              </>
            )}
